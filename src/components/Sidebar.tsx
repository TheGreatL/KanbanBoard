import { Plus, FolderKanban, LogOut, Loader2, Trash2, Pencil, X } from "lucide-react";
  ...
  return (
    <aside className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/50 flex flex-col h-full shrink-0">
        ...
        {isLoading ? (
          ...
          <ul className="space-y-1">
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all ml-2">
                    {editingId !== p.id && (
                      <button
                        ...
                        className="text-zinc-400 hover:text-blue-500 transition-colors p-1 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-800"
                        title="Edit Project"
                      >
                    ...
                    <button
                      ...
                      className="text-zinc-400 hover:text-red-500 transition-colors p-1 rounded-md hover:bg-zinc-200 dark:hover:bg-zinc-800"
            ...
            {projects.length === 0 && !isCreating && (
              <li className="px-3 py-2 text-xs text-zinc-400 text-center">No projects yet.</li>
            )}
          </ul>
        )}
      </div>
      ...
      <div className="p-3 border-t border-zinc-200 dark:border-zinc-800">
        <button
          onClick={onLogout}
          className="flex items-center gap-2 w-full px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800/30 hover:text-zinc-900 dark:hover:text-zinc-100 rounded-lg transition-colors"
        >
